...
exports.convidarUsuarioOrganizacao = onCall({ region: REGION }, async (request) => {
  const uid = requireAuth(request);
...
exports.listarMeusConvitesOrganizacao = onCall({ region: REGION }, async (request) => {
  const uid =
    requireAuth(
      request
    );
...
exports.responderConviteOrganizacao = onCall({ region: REGION }, async (request) => {
  const uid =
    requireAuth(
      request
    );
