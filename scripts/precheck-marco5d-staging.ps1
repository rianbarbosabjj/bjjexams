...
Assert-FileContains -Path "functions/src/finance/asaas-checkout-provider-factory.js" -Text "sandbox-only"
...
Write-Output "MARCO5D_STAGING_PRECHECK=OK"
...
Write-Output "WEBHOOK_COLLECTION_LOCKED=True"
