...
$allowedBranches = @(
    ...
    "feature/marco4b4-student-course-ui",
    "feature/marco5f-purchase-ui-ops"
)

if ($branch -notin $allowedBranches) {
    throw "Execução bloqueada na branch '$branch'. Use uma branch autorizada dos Marcos 4A.4/4A.5/4B.4/5.6."
}
